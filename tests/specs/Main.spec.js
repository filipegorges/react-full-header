...
describe('<FullHeader />', () => {
   ...
   context('subtitle', () => {
       ...
       it('should have h2 with propper text when subtitle is passed', () => {
           const wrapper = shallow(<FullHeader subtitle="curso" />);
   ...
   context('bgColor', () => {
       ...
       it('should have background-color equal #000 when passed', () => {
   ...
   context('bgImg', () => {
       it('should have background-image equal when none is passed', () => {
           const wrapper = shallow(<FullHeader />);
   ...
   context('video', () => {
       ...
       it('should not have video tag when video not is not passed', () => {
           const wrapper = shallow(<FullHeader />);
           expect(wrapper.find('video')).to.have.length(0);
       });

       it('should have video tag with the video is passed', () => {
           const wrapper = shallow(<FullHeader video="my_video.mp4" />);
